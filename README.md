...
<body>
  ...
  <button id="crypto-tool-btn" onclick="window.open('my tools/cryptotool.html')">Cryptography Tool</button>
  ...
  <script>
    ...
    const initialAssignments = [
       { name: "Identity Verification", url: "my assignments/identity.html", status: "completed" },
      { name: "CLI Dungeon Crawl", url: "my assignments/CLI.html", status: "completed" },
      { name: "Virtual Library", url: "my assignments/library.html", status: "completed" },
      { name: "Apps Script", url: "my assignments/appsscript.html", status: "completed" },
      ...
      { name: "Personal Project", url: "my assignments/project2doc.html", status: "completed" },
